...
app.post('/signature', (req, res, next) => {
  console.log(req.body.uri);//this will be automatically set by multer
...
require("./routes/discount.routes.js")(app);
require("./routes/promotion.routes.js")(app);
require("./routes/coupon.routes.js")(app);
